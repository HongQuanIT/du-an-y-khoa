...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: danh sách trước, soạn thảo full-screen. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: thành bottom sheet trượt từ đáy. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: thư mục thành drawer, thẻ 1 cột, vuốt để xóa. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: danh sách 1 cột. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: lưới 1 cột. Màu teal #0F766E, đến hạn #D97706.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: thẻ full-width, nút chấm lớn hàng ngang, hỗ trợ vuốt. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: 2 mặt xếp dọc. Màu teal #0F766E, nhãn AI/Premium gradient vàng-cam.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: KPI 2 cột, chart cuộn ngang, bảng → thẻ. Màu teal #0F766E, chart dùng palette teal/xanh dương.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: gauge trên, grid cuộn, chart full. Màu teal #0F766E, thang đỏ-vàng-xanh.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: lưới cuộn ngang, tap hiện tooltip. Màu teal #0F766E, thang mastery đỏ-vàng-xanh.
```
