...
```
Popover "Ghi chú nhanh" nổi cạnh thanh công cụ câu hỏi/bài viết trong MedLuyện.
...
```
Thanh công cụ nhỏ nổi lên khi người dùng bôi chọn một đoạn văn bản trong bài viết MedLuyện.
...
```
Modal/màn hình "Tạo thẻ ghi nhớ" (route /flashcards/create) của MedLuyện.
