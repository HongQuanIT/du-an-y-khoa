...
├── 05-tai-khoan-va-he-thong.md   ← Notification, Subscription, Billing, Profile, Settings, Organization
└── 06-quan-tri-va-nen-tang.md    ← Admin Dashboard, các Management, RBAC, Audit, Reports, CMS, API
```

## Ánh xạ 43 module → file prompt
...
| Tài khoản + Hệ thống | 27 Notification, 28 Subscription, 29 Billing, 30 Profile, 31 Settings, 32 Organization | `05-tai-khoan-va-he-thong.md` |
