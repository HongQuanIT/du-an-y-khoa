...
├── 02-noi-dung.md                ← AI Tutor, Thư viện, Bệnh học, Dược, Thủ thuật, Ảnh, Video
...
| Nội dung | 08 AI Tutor, 09 Medical Library, 10 Disease, 11 Drug, 12 Procedures, 13 Images, 14 Videos | `02-noi-dung.md` |
