...
```
Dropdown thông báo trượt xuống từ biểu tượng chuông trên header MebPro, rộng ~380px, bo góc, đổ bóng.
...
```
Màn hình "Cài đặt › Quyền riêng tư & Dữ liệu" (route /settings/privacy) của MebPro, app shell.
...
```
Hai màn hình quản lý lớp học của MebPro, app shell tổ chức.
...
```
Hai màn hình của MebPro, app shell tổ chức.
