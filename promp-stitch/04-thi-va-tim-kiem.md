...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: lưới 1 cột. Màu teal #0F766E, nhãn Premium gradient vàng-cam.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: điểm trên, chart full, bảng → thẻ. Màu teal #0F766E, đạt #16A34A, chưa đạt #DC2626.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: radar full, danh sách stack. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: search overlay full-screen, facet bottom sheet. Màu teal #0F766E.
```
...
Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: overlay full-screen, bàn phím tự mở. Màu teal #0F766E, font Be Vietnam Pro.
```
...
Trạng thái không kết quả + gợi ý. Thiết kế 2 màn hình RIÊNG BIỆT (tách rời, KHÔNG gộp chung): một màn hình Desktop với bố cục đầy đủ như mô tả trên, và một màn hình Mobile. Trên mobile: tab cuộn ngang, kết quả 1 cột. Màu teal #0F766E.
```
