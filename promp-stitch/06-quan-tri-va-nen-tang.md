...
```
Hai màn hình Media của MebPro, App shell quản trị.
...
```
Drawer/màn hình chi tiết nhật ký (route /admin/audit/{id}) của MebPro, App shell quản trị.
...
```
Hai màn hình báo cáo của MebPro, App shell quản trị.
...
```
Màn hình quản lý CMS phụ của MebPro, App shell quản trị, dạng nhiều mục quản trị.
...
```
Hai màn hình Developer Portal của MebPro.
