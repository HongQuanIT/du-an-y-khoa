...
```
Màn hình "AI Tutor" (route /ai) của MedLuyện, app shell sidebar + header.
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: ẩn cột trái (mở qua nút), chat full-screen, input sticky đáy. Màu teal #0F766E.
```

### 8.2 Drawer AI theo ngữ cảnh (trong Session/Library)
```
Drawer "Hỏi AI về câu hỏi này" trượt từ bên phải, phủ 40% màn hình, dùng trong màn làm bài/đọc bài MedLuyện.
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: drawer full-screen từ đáy. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: lưới 2 cột → 1 cột. Màu teal #0F766E.
```
...
Trạng thái rỗng: "Không tìm thấy kết quả cho 'nhồi máu cơ tim' — thử từ khóa khác". Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: bộ lọc thành bottom sheet. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: TOC thành bottom sheet, aside xuống dưới, toolbar thành menu .... Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: lưới 2 cột → 1. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: section nav thành accordion, DDx table cuộn ngang. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: các cột chuyển thành thẻ cuộn ngang. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: 2 cột → 1. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: accordion, bảng liều cuộn ngang. Màu teal #0F766E.
```
...
Trạng thái: cần ≥2 thuốc mới kiểm tra được; rỗng "Chưa phát hiện tương tác đáng kể". Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: chip xuống dòng. Màu teal #0F766E, cảnh báo đỏ #DC2626 / cam #D97706.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: lưới co giãn 1 cột. Màu teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: các bước dạng slider vuốt ngang, checklist accordion. Màu teal #0F766E.
```
...
Trạng thái loading blur-up placeholder. Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: 2 cột, pinch zoom. Màu teal #0F766E.
```

### 13.2 Xem chi tiết ảnh / Viewer (`/images/{id}`)
```
Màn hình viewer ảnh y khoa toàn màn hình (route /images/{id}) của MedLuyện, nền tối để nổi ảnh.
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: viewer full-screen, pinch-zoom, thông tin ở bottom sheet. Nền tối, nhấn teal #0F766E.
```
...
Tạo đồng thời 2 khung trong cùng màn hình — bản Desktop (bố cục đầy đủ như mô tả trên) và bản Mobile. Trên mobile: player full-width, chương/transcript thành tab dưới. Màu teal #0F766E.
```
