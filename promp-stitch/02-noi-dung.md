...
```
Màn hình "AI Tutor" (route /ai) của MebPro, app shell sidebar + header.
...
```
Drawer "Hỏi AI về câu hỏi này" trượt từ bên phải, phủ 40% màn hình, dùng trong màn làm bài/đọc bài MebPro.
...
```
Màn hình viewer ảnh y khoa toàn màn hình (route /images/{id}) của MebPro, nền tối để nổi ảnh.
