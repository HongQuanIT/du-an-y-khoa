...
return [
    ...
    */
    'stubs' => [
        ...
        // Lean monolith: no per-module npm/vite/assets. Frontend build is centralised
        // at the app root (Vite) and module JS/CSS live under resources/ when needed.
        'files' => [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            // app/ — enable only the layers our architecture uses.
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'medlearn'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'MedLearn Team'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'dev@medlearn.local'),
        ],
