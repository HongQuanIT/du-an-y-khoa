...
final class ListQuestionsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'filter.organ_system_id' => ['nullable', 'array'],
            'filter.organ_system_id.*' => ['integer', 'min:1'],
            'filter.subject_id' => ['nullable', 'array'],
            'filter.subject_id.*' => ['integer', 'min:1'],
            'filter.lesson_id' => ['nullable', 'array'],
            'filter.lesson_id.*' => ['integer', 'min:1'],
    ...
    public function toData(): ListQuestionsData
    {
        ...
        return new ListQuestionsData(
            ...
            organSystemIds: $this->integerList('filter.organ_system_id'),
            subjectIds: $this->integerList('filter.subject_id'),
            lessonIds: $this->integerList('filter.lesson_id'),
