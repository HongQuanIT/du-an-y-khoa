<x-layouts.admin title="Review câu hỏi">
    ...
    <nav class="mb-5 flex gap-2" aria-label="Trạng thái hàng đợi review">
        <a href="{{ route('admin.questions.flags.index', ['tab' => 'pending']) }}"
            @class([
        ...
        <a href="{{ route('admin.questions.flags.index', ['tab' => 'done']) }}"
            @class([
                'rounded-lg px-3 py-2 font-label-sm',
                ...
                @forelse ($questions as $question)
                    <tr class="border-t border-outline-variant">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('admin.questions.flags.show', $question) }}" class="font-semibold text-primary">Xem</a>
                        </td>
                    </tr>
                @empty
                    <tr>
