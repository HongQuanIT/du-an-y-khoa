    ...
    private function roomUrls(Classroom $classroom, LiveSession $liveSession, bool $teachPortal, bool $observer): array
    {
        if ($observer) {
            return [
                ...
                'question_panel' => route('admin.classrooms.live.api.bootstrap', [$classroom, $liveSession]),
                ...
                'speakers_invite' => route('admin.classrooms.live.api.bootstrap', [$classroom, $liveSession]),
                'speakers_mute' => route('admin.classrooms.live.api.bootstrap', [$classroom, $liveSession]),
                'speakers_unmute' => route('admin.classrooms.live.api.bootstrap', [$classroom, $liveSession]),
        ...
        return [
            ...
            'question_panel' => route($teachPortal ? 'teach.classes.sessions.studio.api.question.show' : 'classroom.live.api.question.show', [$classroom, $liveSession]),
            ...
            'speakers_invite' => route($teachPortal ? 'teach.classes.sessions.studio.api.speakers.invite' : 'classroom.live.api.speakers.invite', [$classroom, $liveSession, '__USER__']),
            'speakers_mute' => route($teachPortal ? 'teach.classes.sessions.studio.api.speakers.mute' : 'classroom.live.api.speakers.mute', [$classroom, $liveSession, '__USER__']),
            'speakers_unmute' => route($teachPortal ? 'teach.classes.sessions.studio.api.speakers.unmute' : 'classroom.live.api.speakers.unmute', [$classroom, $liveSession, '__USER__']),
