...
Route::middleware(['auth', 'learner', 'permission:classroom.view'])
    ...
    ->group(function (): void {
        ...
        Route::post('/{classroom}/live/{liveSession}/messages', [LiveRoomController::class, 'message'])->middleware('permission:classroom.view')->name('live.message');
        ...
        Route::prefix('/{classroom}/live/{liveSession}/api')->name('live.api.')->group(function (): void {
            ...
            Route::get('/question', [LiveQuestionController::class, 'show'])->middleware('permission:classroom.view')->name('question.show');
