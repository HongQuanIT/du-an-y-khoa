...
<body data-presenter-root
    ...
    @if ($canModerate)
        <footer style="margin-top:1.5rem;display:flex;gap:0.5rem;flex-wrap:wrap;">
            ...
            <button type="button" data-q-toggle-answer style="margin-left:auto;padding:0.5rem 1rem;border:none;border-radius:0.5rem;background:#2563eb;color:#fff;cursor:pointer;">Hiện đáp án</button>
        </footer>
