...
enum AuditAction: string
{
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::ClassroomLiveScheduled => 'Lên lịch buổi trực tiếp',
            self::ClassroomLiveStarted => 'Bắt đầu buổi trực tiếp',
            self::ClassroomLiveEnded => 'Kết thúc buổi trực tiếp',
            self::ClassroomRecordingStarted => 'Bắt đầu ghi hình buổi trực tiếp',
            self::ClassroomRecordingStopped => 'Dừng ghi hình buổi trực tiếp',
            self::ClassroomMemberKicked => 'Mời học viên khỏi buổi trực tiếp',
            self::ClassroomChatToggled => 'Thay đổi trạng thái trò chuyện',
            self::ClassroomQuestionChanged => 'Thay đổi câu hỏi trực tiếp',
            self::ClassroomMessageDeleted => 'Xóa tin nhắn trực tiếp',
